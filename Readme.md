...
## Ограничения
В пробной версии плагина не предусмотрена синхронизация по расписанию, 
оповещения по email, а так же существует ограничение  - 10 тикетов в 
рамках одной задачи на синхронизацию.
...
1. Скачайте установочный файл по ссылке в шапке сайта или в разделе 
   "Цена".
...
4. Нажмите Upload App и в открывшемся окне добавьте скачанный файл с помощью кнопки выбора файла.
